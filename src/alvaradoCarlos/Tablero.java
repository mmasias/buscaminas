...
public class Tablero {
    ...
    public void actualizarTablero(char opcion, int[] coordenadas) {
        ...
        if (opcion == 'D') {
            manejarDescubrir(fila, columna);
        } else if (opcion == 'M') {
            manejarMarcar(fila, columna);
        } else if (opcion == 'R') {
            manejarRetirarMarca(fila, columna);
        } else if (opcion == 'X') {
            manejarMacroDescubrir(fila, columna);
        } else {
    ...
    public void macroDescubrir(int fila, int columna) {
        for (int i = 0; i < ADYACENTES_X.length; i++) {
            ...
            if (estaEnRango(nuevaFila, nuevaColumna)) {
                if (!celdaOcupada(nuevaFila, nuevaColumna) && !minas[nuevaFila][nuevaColumna]) {
    ...
    private void manejarDescubrir(int fila, int columna) {
    ...
    private void manejarMarcar(int fila, int columna) {
    ...
    private void manejarRetirarMarca(int fila, int columna) {
    ...
    public boolean haExplotadoUnaMina() {
